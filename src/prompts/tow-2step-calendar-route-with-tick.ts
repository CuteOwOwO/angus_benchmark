export const PROMPT_NAME = "tow-2step-calendar-route-with-tick";
...
The runtime may send brief pending status messages while a tool call is still running.
Treat pending status messages only as progress reminders.
They are not tool results, nor the final answer.
Do not repeat or paraphrase pending status messages mechanically.
